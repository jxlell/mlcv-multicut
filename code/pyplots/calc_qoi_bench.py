...
# Calculate and print the average "rate" for each group
group_averages = data_grouped.groupby('group')['rate'].mean()
print(group_averages)

# Calculate and print the median "rate" for each group
group_medians = data_grouped.groupby('group')['rate'].median()
print(group_medians)