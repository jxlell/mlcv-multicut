...
# Calculate and print the mean rates for the specified columns
mean_rates = data[columns_to_compare].mean()
...
plt.savefig('/Users/jalell/Documents/GitHub/thesis-multicut/img/boxplot_rates-icons.pdf')  # Save the plot as a PNG file
plt.show()